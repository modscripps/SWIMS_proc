function Vel = Get_ADCP_SwimsDN_info(RDIname, filetype, savetype);
% Vel = Get_ADCP_SwimsDN_info(RDIname, filetype, savetype);
...
%	savetype: 0=just depth,time,position,orientation,BT vectors,
